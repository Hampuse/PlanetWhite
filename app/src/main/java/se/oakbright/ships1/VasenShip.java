...
/*public class VasenShip extends Ship{
	...
	private final static int VELOCITY = 800000;
	
	
	public VasenShip(BattleModel battleModel, BattleTeam team) {
		super(); //TODO ...battleModel, team, VasenShip.iconChooser.chooseIconId(team.teamColor));
		//TODO weapon =  new MissileLauncher(this);
		//TODO this.mover = new ObMoverBouncer(battleModel.trackFrame, this, VasenShip.VELOCITY);
		//TODO this.hp = 200;
	}
